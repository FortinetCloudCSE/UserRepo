...
2. To comply with Page Bundle standards, generally the md page should be named `index.md` if it's a task page, or `_index.md` for section/chapter pages, 

    {{% notice info %}} The Title and Weight dictate the leftnav visual and ordering of the pages.  Lower weight pages are displayed first{{% /notice %}}
    {{< figure src="taskPage.png" alt="taskPage" >}}
